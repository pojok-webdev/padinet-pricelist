...
/* harmony import */ var _appvar_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./appvar.service */ "./src/app/appvar.service.ts");




var CategoryService = /** @class */ (function () {
    function CategoryService(http, appvar) {
        this.http = http;
        this.appvar = appvar;
    }
    CategoryService.prototype.gets = function (callback) {
        this.obj = this.http.get(this.appvar.serverport + 'categorygets');
        this.obj.subscribe(function (data) {
            callback(data);
        }, function (err) {
            callback(err);
        });
    };
    CategoryService.prototype.save = function (obj, callback) {
    ...
    CategoryService.prototype.update = function (obj, callback) {
    ...
    CategoryService.prototype.getcapacities = function (obj, callback) {
    ...
    CategoryService.prototype.servicenamegetbycatgory = function (obj, callback) {
    ...
    CategoryService.prototype.getprices = function (obj, callback) {
    ...
    CategoryService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _appvar_service__WEBPACK_IMPORTED_MODULE_3__["AppvarService"]])
    ], CategoryService);
...
/***/ "./src/app/customs.service.ts":
/*!************************************!*\
  !*** ./src/app/customs.service.ts ***!
  \************************************/
/*! exports provided: CustomsService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CustomsService", function() { return CustomsService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _appvar_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./appvar.service */ "./src/app/appvar.service.ts");
...
var CustomsService = /** @class */ (function () {
    function CustomsService(http, appvar) {
        this.http = http;
        this.appvar = appvar;
    }
    CustomsService.prototype.save = function (obj, callback) {
        this.obj = this.http.post(this.appvar.serverport + 'customsave', obj);
        this.obj.subscribe(function (data) {
            callback(data);
        }, function (err) {
            callback(err);
    ...
    CustomsService.prototype.gets = function (callback) {
        this.obj = this.http.get(this.appvar.serverport + 'customgets');
        this.obj.subscribe(function (data) {
            callback(data);
        }, function (err) {
            callback(err);
    ...
    CustomsService.prototype.getByMonth = function (obj, callback) {
        this.obj = this.http.get(this.appvar.serverport + 'getbymonth/' + obj.monthyear);
        this.obj.subscribe(function (data) {
            callback(data);
        }, function (err) {
            callback(err);
    ...
    CustomsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _appvar_service__WEBPACK_IMPORTED_MODULE_3__["AppvarService"]])
